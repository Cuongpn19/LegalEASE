...
<head>
    ...
    <style>
        ...
        /* Hiệu ứng chuyển động mượt mà cho Content Area */
        /* #page-content-wrapper {
        ...
        <div id="sidebar-wrapper">
            ...
            <div class="mt-3">
                <a href="{{ route('admin.dashboard') }}"
                    class="nav-link-custom {{ request()->routeIs('admin.dashboard') ? 'active-link' : '' }}">
                    <i class="fas fa-house"></i> Dashboard
                </a>

                <div>
                    <a class="nav-link-custom justify-content-between {{ request()->routeIs('admin.users.*') ? 'active-link' : '' }}"
                        ...
                        <i class="fas fa-chevron-down rotate-icon small"></i>
                    </a>
                    <div class="collapse {{ request()->routeIs('admin.users.*') ? 'show' : '' }}" id="userSubmenu">
                        <div class="submenu bg-dark bg-opacity-25">
                            <a href="{{ route('admin.users.index', ['role' => 'lawyer']) }}" class="nav-link-custom">
                                <i class="fas fa-user-tie"></i> Lawyer
                            </a>
                            <a href="{{ route('admin.clients.index', ['role' => 'client']) }}" class="nav-link-custom">
                ...
                <a href="{{ route('admin.appointments.index') }}"
                    class="nav-link-custom {{ request()->routeIs('admin.appointments.*') ? 'active-link' : '' }}">
                    <i class="fas fa-calendar-check"></i> Appointment schedule
                </a>

                <a href="{{ route('admin.contents.index') }}"
                    class="nav-link-custom {{ request()->routeIs('admin.contents.*') ? 'active-link' : '' }}">
                    <i class="fas fa-file-lines"></i> Legal content
                </a>

                <a href="{{ route('admin.reports.index') }}"
                    class="nav-link-custom {{ request()->routeIs('admin.reports.*') ? 'active-link' : '' }}">
